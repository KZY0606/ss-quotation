...
const ORIGIN_THICKNESS_SURCHARGE = {
  ...
  // v1.0.187 本地201(压延)：冷轧压延料专属厚度加价（0.31-0.32 未给档，暂并入 0.29-0.30 档 +1000）
  '本地201(压延)': [
...
const ORIGIN_KEYWORDS = ['宏旺', '青山', '联众', '甬金', '太钢', '德龙', '上克', '瑞钢',
  '北港', '张浦', '酒钢', '宝钢', '鞍钢', '东方特钢', '硕阳', '鼎信', '永达', '金海', '鑫峰', '本地201(压延)', '本地201', '本地']; // v1.0.187 本地201(压延)（'压延'二字保留给轧硬料 isYanYan 检测，不作为产地关键词）
