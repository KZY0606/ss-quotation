...
const App = (() => {
  ...
  function renderSurfaceConfig() {
    ...
    const surfOrder = [
      ...
      // AFP 彩色表面
      { display: '砂面/拉丝(NO.4/HL)黄钛金亮光无指纹', key: '拉丝黄钛金亮光无指纹' },
      { display: '砂面/拉丝(NO.4/HL)黄钛金哑光无指纹', key: '拉丝黄钛金哑光无指纹' },
      { display: '砂面/拉丝(NO.4/HL)玫瑰金亮光无指纹', key: '拉丝玫瑰金亮光无指纹' },
      { display: '砂面/拉丝(NO.4/HL)玫瑰金哑光无指纹', key: '拉丝玫瑰金哑光无指纹' },
      { display: '砂面/拉丝(NO.4/HL)香槟金亮光无指纹', key: '拉丝香槟金亮光无指纹' },
      { display: '砂面/拉丝(NO.4/HL)香槟金哑光无指纹', key: '拉丝香槟金哑光无指纹' },
      { display: '砂面/拉丝(NO.4/HL)黑钛金亮光无指纹', key: '拉丝黑钛金亮光无指纹' },
      { display: '砂面/拉丝(NO.4/HL)黑钛金哑光无指纹', key: '拉丝黑钛金哑光无指纹' }
    ];
