...
test('v1.0.218 304 产地专属表归位（甬金/上克并入 304 表、张浦去重、梓烨201 拆到 201 表）', () => {
  ...
  eq(g('0.50', '304', '甬金'), 700, '304 甬金 0.50 = 700');
  eq(g('0.90', '304', '甬金'), 400, '304 甬金 0.90 = 400');
  eq(g('0.40', '304', '上克'), 850, '304 上克 0.40 = 850');
  eq(g('0.75', '304', '上克'), 450, '304 上克 0.75 = 450');
  eq(g('0.90', '304', '上克'), 350, '304 上克 0.90 = 350');
  eq(g('0.50', '304', '张浦'), 900, '304 张浦 0.50 = 900（与旧表一致）');
  eq(g('5.00', '304', '张浦'), 500, '304 张浦 5.00 = 500');
  ...
  eq(c('上克').detail.thickTable, '上克 加价', '上克 304 表名');
  eq(c('张浦').detail.thickTable, '张浦 加价', '张浦 304 表名');
