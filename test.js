...
test('单张高普8K彩色系列 11色（2026-08-24 v1.0.87 用户修正：高普按厚度档[新5档] + 颜色基础价 + 颜色厚度加价；1000mm ×1.25）', () => {
  ...
  // 黄钛金 窄板 8 段：0.24-1.2=10 / 1.21-1.49=14 / 1.50=16 / 1.51-1.59=18 / 1.60-1.69=28 / 1.70-1.79=31 / 1.80-1.89=34 / 1.90-2.00=38
  eq([0.5, 1.3, 1.5, 1.55, 1.65, 1.75, 1.85, 1.95].map(t => g('单张高普8K黄钛金', t, 1219)).join('/'), '10/14/16/18/28/31/34/38', '黄钛金窄板8段（1.51-1.59=18 用户例：8+6+4）');
